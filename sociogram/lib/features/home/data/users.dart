...
UserModel RashiKhanna = UserModel(
    assetName: 'assets/Raashi-Khanna-Filmography.jpg', userName: 'Rashi Khanna');
UserModel AlluArjun = UserModel(
    assetName: 'assets/alluarjun.jpg', userName: 'AlluArjun');
UserModel bawaraa =
    UserModel(assetName: 'assets/3_bawaraa.jpeg', userName: 'bawaraa');
UserModel pawan = UserModel(
    assetName: 'assets/pawan.jpg', userName: 'pawan');
...
List<PostModel> posts = [
  PostModel(
    user: RashiKhanna,
    caption:
        "Embracing the timeless beauty of black and white, channeling the essence of beauty symbolism. 🖤✨ #Rashikhanna #MonochromeMagic #SpiritualElegance",
    liked: true,
